...
function Message({ msg, transcript, hl }: { msg: Message, transcript: Transcript, hl: string }) {
  ...
  return <div className={`mb-2 w-full ${hl == msg.discordId ? styles.highlight : styles.nothl} bg-blue-400 rounded-xl transition-all duration-200 ease-in-out`} id={msg.discordId}>
