...
export default function Footer({ location, marginBottom }: { location: string, marginBottom?: number }) {
    return <footer className="flex flex-col items-center justify-center w-full border-t border-gray-200 text-center" style={({ marginBottom: marginBottom && `${marginBottom}px` })}>
